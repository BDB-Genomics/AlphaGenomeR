#' Extract CHIP_HISTONE data from the AlphaGenome API response
#'
...
#' data <- alphagenome_get_chip_histone(response)
#' }
alphagenome_get_chip_histone <- function(response_body) {

  # EXTRACT THE CHIP DATA
  track_data <- response_body$chip_histone
