#' Extract ATAC data from the AlphaGenome API response
#'
...
#' data <- alphagenome_get_atac(response)
#' }
alphagenome_get_atac <- function(response_body) {

  # EXTRACT THE ATAC DATA
  track_data <- response_body$atac
