#' Extract CHIP_TF data from the AlphaGenome API response
#'
...
#' data <- alphagenome_get_chip_tf(response)
#' }
alphagenome_get_chip_tf <- function(response_body) {

  # EXTRACT THE CHIP DATA
  track_data <- response_body$chip_tf
